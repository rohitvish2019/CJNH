...
Router.get('/all', passport.checkAuthentication, PatientsController.getAllPatients);
Router.get('/details/:mongoId', passport.checkAuthentication, PatientsController.getPatientDetailsByMongoId);
Router.get('/profile/:id', passport.checkAuthentication, PatientsController.patientProfilePage);
Router.post('/update/:id', passport.checkAuthentication, PatientsController.updatePatientDetails);
